...
{
    public class ActionShowDatePicker
    {
        #region -= declarations =- 
 		...
 		///  
 		/// </summary> 
 		public ActionShowDatePicker(UIView owner)
 		{ 
 		...
 		{ 
 			...
 			SizeF actionSheetSize = new SizeF((float)owner.Frame.Width, (float)datePicker.Frame.Height + titleBarHeight); 
 			RectangleF actionSheetFrame = new RectangleF(0, (float)owner.Frame.Height - actionSheetSize.Height, actionSheetSize.Width, actionSheetSize.Height); 
 			...
 			datePicker.Frame = new RectangleF((float)datePicker.Frame.X, titleBarHeight, (float)datePicker.Frame.Width, (float)datePicker.Frame.Height); 
 			 
 			// move our label to the top of the action sheet 
 			titleLabel.Frame = new RectangleF(10, 4, (float)owner.Frame.Width - 100, 35); 
